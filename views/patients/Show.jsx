            ...
            <div className="container">
                ...
                <div className="patient-card">
                    ...
                    <div className="d-flex gap-2 mt-3">
                        <a href={`/patients?token=${token}`} className="btn btn-secondary">
                            ← Back to All Patients
                        </a>
                        <a href={`/patientRecords/${patient._id}/history?token=${token}`} className="btn btn-primary">
                            📜 View Medical History
                        </a>


                        <a href={`/patients/${patient._id}/edit?token=${token}`} className="btn btn-primary">
                            ✏️ Edit {patient.name}
                        </a>
                    </div>
                    ...
                    {/* Delete Form */}
                    <div className="mt-3">
                        <form action={`/patients/${patient._id}?_method=DELETE&token=${token}`} method="POST">
